...
namespace dci::module::ppn::node::link
{
    namespace
    {
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Local>(ilid, manager())) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::node::link::entry_;
}
